...
class CloudStorageApplicationTests {
    ...
    public void createCredential() throws InterruptedException {
        ...
        // Verify the credentials appears
        ...
        // Verify the password shown in table is encrypted or not equal to the original password
    ...
    public void editCredentials() throws InterruptedException {
        ...
        inputURL.click();
        inputURL.clear();
        inputURL.sendKeys("https://google.com");
        ...
        // Make changes
        webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("credentialTable")));
        Assertions.assertTrue(driver.findElement(By.id("table-cred-url")).getText().contains("https://google.com"));
    ...
    public void deleteCredentials() throws InterruptedException {
        ...
        // Redirect to home page & click on credentials tab
        redirectToCredentialsTab();
